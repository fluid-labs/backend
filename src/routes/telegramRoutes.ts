...
router.post(
    "/messages/:messageId/process",
    telegramController.processPendingMessage
);
...
router.get(
    "/ardrive/files/:fileId/cost",
    telegramController.getUploadCostEstimate
);
router.post(
    "/ardrive/files/:fileId/upload",
    telegramController.uploadFileToArDrive
);
