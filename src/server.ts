...
emailRouter.post('/send', async (req: Request<{}, {}, EmailRequest>, res: Response) => {
  try {
...
documentRouter.post('/', (req: Request<{}, {}, DocumentCreateRequest>, res: Response) => {
  try {
...
documentRouter.put('/:id', (req: Request<{ id: string }, {}, Partial<DocumentCreateRequest>>, res: Response) => {
  try {
    const { id } = req.params;
    const { fileName, fileSize, contentType, content, uploadedBy, department } = req.body;
